...
@Ignore
class ApiV1PoiControllerAllowedMethodSpec extends HibernateSpec implements ControllerUnitTest<PoiController> {
    ...
    def "test PoiController.index accepts POST requests"() {
        when:
        request.method = 'GET'
        controller.index()
