	...
	plugin {
		...
		springsecurity {
			...
			interceptUrlMap = [
					...
					[pattern: '/hotel/index',  access: ['permitAll']],
					[pattern: '/hotel/show/*',  access: ['permitAll']],
					...
					[pattern: '/restaurant/index',  access: ['permitAll']],
					[pattern: '/restaurant/show/*',  access: ['permitAll']],
					...
					[pattern: '/poi/index',  access: ['permitAll']],
					[pattern: '/poi/show/*',  access: ['permitAll']],
					...
					[pattern: '/village/index',  access: ['permitAll']],
					[pattern: '/village/show/*',  access: ['permitAll']],
