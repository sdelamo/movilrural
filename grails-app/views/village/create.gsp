    ...
    <body>
        ...
        <div class="nav" role="navigation">
            <ul>
                ...
                <li><g:link class="list" action="index"><g:message code="village.list.label" default="Villages" /></g:link></li>
            </ul>
        </div>
        <div id="create-village" class="content scaffold-create" role="main">
